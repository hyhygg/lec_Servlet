...
public class MemberListServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			/* AppInitServlet 에서 저장한 Connection객체를
			 * ServletContext 영역에서 꺼내온다.
			 * */
...
//			rd.forward(req, resp);
			...
			out.println("<p><mark>MemberListServlet-End</mark></p>");
		}catch(Exception e) {
			...
			/* conn을 꺼내서 사용하기만 하고 닫으면 안된다
			 * AppInitServlet 에서 닫는다.
			try {
				if(conn!=null) 
					conn.close();
			}catch(Exception e) {
